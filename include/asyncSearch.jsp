...
<%
    ...
    String sort = interpret(request.getParameter("sort"), "score+desc");                // 검색 정렬 차순
    ...
    if( tempCollList[target].equals("img") ) pagemax = "20";                // 이미지 컬렉션일 경우 30건씩가져오기
    // 상세검색
    ...
    try{
        ...
        System.out.println("target=" + target + ", query = " + query + ",tuningQuery = " + tuningQuery );
